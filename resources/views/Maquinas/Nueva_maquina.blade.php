...
<div class="formulario">
    ...
    <hr>
    <form class="needs-validation" action="{{route('guardarmaquina')}}" method='POST' enctype='multipart/form-data'>
    {{csrf_field()}}
        <div class="form-row">
            <!--------------------------------------------- Descripcion ------------------------------------------->
            <div class="col-sm-12 col-md-12 col-lg-12">
                ...
                <div class="input-group">
                    ...
                    <input type="text" class="form-control" name="nombre_maq" id="nombre_maq" value="{{old('nombre_maq')}}" placeholder="Nombre de la maquina" >
                </div>
            ...
            <div class="col-sm-12 col-md-12 col-lg-12">
                ...
                <div class="input-group">
                    ...
                    <input type="text" class="form-control"name="descripcion_maq" id="descripcion_maq" value="{{old('descripcion_maq')}}" placeholder="Descripcion de la maquina" >
                </div>
            ...
            <div class="col-sm-4 col-md-4 col-lg-4">
                ...
                <div class="input-group">
                    ...
                    <input type="text" class="form-control"  name="existencia" id="existencia" value="{{old('existencia')}}" placeholder="Existencias" >
                </div>
            ...
            <div class="col-sm-4 col-md-4 col-lg-4">
                ...
                <div class="input-group">
                    ...
                    <input type="text" class="form-control" name="precio" id="precio" value="{{old('precio')}}" placeholder="Precio de la maquina" >
                </div>
