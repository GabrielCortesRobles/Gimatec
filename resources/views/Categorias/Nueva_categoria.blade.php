...
<div class="formulario">
     ...
     <hr>
     <form class="needs-validation" action="{{route('guardarcategoria')}}" method='POST' enctype='multipart/form-data'>
        {{csrf_field()}}
        <div class="form-row">
             <!--------------------------------------------- Descripcion ------------------------------------------->
             <div class="col-sm-12 col-md-12 col-lg-12">
                ...
                <div class="input-group">
                    ...
                    <input type="text" class="form-control" name="categoria" id="categoria" value="{{old('categoria')}}" placeholder="Nueva Categoria" >
                </div>
            ...
            <div class="col-sm-12 col-md-12 col-lg-12">
                ...
                <div class="input-group">
                    ...
                    <input type="text" class="form-control"name="descripcion" id="descripcion" value="{{old('descripcion')}}" placeholder="Descripcion de la nueva categoria" >
                </div>
